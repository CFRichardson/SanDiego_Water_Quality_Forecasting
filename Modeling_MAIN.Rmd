---
title: "ADS 506 - Final Project MODELING"
...
# Loading Data
```{r echo=FALSE, message=FALSE, warning=FALSE}
wq_df = read.csv('Data/water_quality_2011_2019_datasd.csv')
# Combine Date/Time
wq_df['datetime'] = as.POSIXct(paste(wq_df$date_sample, wq_df$time), format="%Y-%m-%d %H:%M:%S")
head(wq_df)
```

## Data Dictionary
```{r}
wq_dict = read.csv('water_quality_dictionary_datasd.csv')
wq_dict
```
